...
import 'edit_prediction_model.dart';
export 'edit_prediction_model.dart';

class EditPredictionWidget extends StatefulWidget {
  const EditPredictionWidget({
    Key? key,
    required this.tournamentRef,
    required this.matcheRef,
    required this.userRef,
    required this.matchStandingsRef,
  }) : super(key: key);

  final DocumentReference? tournamentRef;
  final DocumentReference? matcheRef;
  final DocumentReference? userRef;
  final DocumentReference? matchStandingsRef;

  @override
  _EditPredictionWidgetState createState() => _EditPredictionWidgetState();
}

class _EditPredictionWidgetState extends State<EditPredictionWidget> {
  late EditPredictionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPredictionModel());
  }
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      StreamBuilder<MatchStandingsRecord>(
                        stream: MatchStandingsRecord.getDocument(
                            widget.matchStandingsRef!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                          ...
                          final rowMatchStandingsRecord = snapshot.data!;
                          return Row(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                              Container(
                                ...
                                child: FlutterFlowCountController(
                                  ...
                                  count: _model.homeGoalsCCValue ??=
                                      rowMatchStandingsRecord.homeGoals,
                              ...
                              Container(
                                ...
                                child: FlutterFlowCountController(
                                  ...
                                  count: _model.awayGoalsCCValue ??=
                                      rowMatchStandingsRecord.awayGoals,
                                  updateCount: (count) => setState(
