...
class TStandingsRecord extends FirestoreRecord {
  TStandingsRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('TStandings')
          : FirebaseFirestore.instance.collectionGroup('TStandings');

  static DocumentReference createDoc(DocumentReference parent) =>
      parent.collection('TStandings').doc();

  static Stream<TStandingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => TStandingsRecord.fromSnapshot(s));

  static Future<TStandingsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => TStandingsRecord.fromSnapshot(s));

  static TStandingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      TStandingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static TStandingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      TStandingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'TStandingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is TStandingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTStandingsRecordData({
  String? userID,
  String? userName,
  int? rank,
  int? oldRank,
...
class TStandingsRecordDocumentEquality implements Equality<TStandingsRecord> {
  const TStandingsRecordDocumentEquality();

  @override
  bool equals(TStandingsRecord? e1, TStandingsRecord? e2) {
  ...
  @override
  int hash(TStandingsRecord? e) => const ListEquality().hash([
        e?.userID,
        e?.userName,
        e?.rank,
        e?.oldRank,
  ...
  @override
  bool isValidKey(Object? o) => o is TStandingsRecord;
}
