        ...
        children: [
          ...
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                _model.teamExists = await actions.ifTeamDocumentExists(
                  _model.teamnameFieldController.text,
                );
                if (!_model.teamExists!) {
                  final teamsCreateData = createTeamsRecordData(
                    teamName: _model.teamnameFieldController.text,
