...
class Profile15Widget extends StatefulWidget {
  const Profile15Widget({Key? key}) : super(key: key);

  @override
  _Profile15WidgetState createState() => _Profile15WidgetState();
}
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'o36fj66i' /* Notification Settings */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyLarge,
                      ),
                    ],
