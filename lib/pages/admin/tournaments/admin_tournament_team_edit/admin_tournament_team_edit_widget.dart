...
import 'admin_tournament_team_edit_model.dart';
export 'admin_tournament_team_edit_model.dart';
...
class AdminTournamentTeamEditWidget extends StatefulWidget {
  ...
  _AdminTournamentTeamEditWidgetState createState() =>
      _AdminTournamentTeamEditWidgetState();
}

class _AdminTournamentTeamEditWidgetState
    extends State<AdminTournamentTeamEditWidget> {
  late AdminTournamentTeamEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminTournamentTeamEditModel());
