...
import 'admin_tournaments_list_model.dart';
export 'admin_tournaments_list_model.dart';

class AdminTournamentsListWidget extends StatefulWidget {
  const AdminTournamentsListWidget({Key? key}) : super(key: key);

  @override
  _AdminTournamentsListWidgetState createState() =>
      _AdminTournamentsListWidgetState();
}

class _AdminTournamentsListWidgetState
    extends State<AdminTournamentsListWidget> {
  late AdminTournamentsListModel _model;
