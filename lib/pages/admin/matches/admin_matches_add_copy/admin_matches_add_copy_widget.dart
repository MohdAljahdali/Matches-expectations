...
import 'admin_matches_add_copy_model.dart';
export 'admin_matches_add_copy_model.dart';

class AdminMatchesAddCopyWidget extends StatefulWidget {
  const AdminMatchesAddCopyWidget({Key? key}) : super(key: key);

  @override
  _AdminMatchesAddCopyWidgetState createState() =>
      _AdminMatchesAddCopyWidgetState();
}

class _AdminMatchesAddCopyWidgetState extends State<AdminMatchesAddCopyWidget> {
  late AdminMatchesAddCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminMatchesAddCopyModel());
