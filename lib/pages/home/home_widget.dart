...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    _model.tournamentsTFController ??= TextEditingController();
    _model.seasonTFController ??= TextEditingController();
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.tournamentsTFController?.text =
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TournamentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TournamentsRecord> homeTournamentsRecordList = snapshot.data!;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.tournamentsTFController,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      .tournamentsTFControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                      ...
                      StreamBuilder<List<TournamentsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<TournamentsRecord>
                              dropDownTournamentsRecordList = snapshot.data!;
